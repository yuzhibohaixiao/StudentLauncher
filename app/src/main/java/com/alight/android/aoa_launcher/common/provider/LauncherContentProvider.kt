package com.alight.android.aoa_launcher.common.provider
...
class LauncherContentProvider : ContentProvider() {
    ...
    companion object {
        const val AUTHORITY =
            "com.alight.android.aoa_launcher.common.provider.LauncherContentProvider"
        var URI =
            Uri.parse("content://$AUTHORITY/child")
